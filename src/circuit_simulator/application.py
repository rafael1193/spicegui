...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 21 23:44:33 2014
...
class App(Gtk.Application):
    ...
    def __init__(self):
        Gtk.Application.__init__(self,
                                 application_id="org.rafael1193.circuit-simulator",
...
#        self.add_action(help_action)
    ...
    def on_about_action(self, action, parameter):
        ...
        aboutdialog.set_title("About Circuit Simulator")
        aboutdialog.set_program_name("Circuit Simulator")
